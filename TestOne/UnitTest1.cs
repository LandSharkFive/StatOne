...
namespace TestOne
{
    ...
    public class UnitTest1
    {
        ...
        {
            double[] data = { 4, 4, 5, 6, 7, 8, 9, 10, 21, 46, 86 };
        ...
        {
            double[] dataX = { 9, 15, 25 };
            double[] dataY = { 10, 19, 29 };

            double y = 0;
            double slope = Util.GetSlopeIntercept(dataX, dataY, out y);
        ...
        {
            double[] dataX = { 4, 4, 5, 6, 7, 8, 9, 10, 21, 46, 86 };
            double[] dataY = { 5, 3, 5, 7, 8, 10, 9, 11, 22, 45, 84 };

            double cor = Util.Correlation(dataX, dataY);
        ...
        {
            double[] dataX = { 3, 5, 7, 9, 11, 15, 31, 42 };
            double[] dataY = { 4, 5, 8, 10, 12, 11, 29, 45 };
        ...
        {
            double[] dataX = { 7, 10, 11, 13, 15, 22 };
            double[] dataY = { 6, 12, 13, 14, 17, 23 };

            double r2 = Util.RSquared(dataX, dataY);
        ...
        {
            double[] dataX = { 2, 4, 9, 13, 15, 22, 32 };
            double[] dataY = { 4, 6, 8, 15, 18, 25, 30 };
